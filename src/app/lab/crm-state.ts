...
export const CRM_STATES = ["LEAD", "QUALIFIED", "OPPORTUNITY", "WON", "ACTIVE", "AT_RISK", "DORMANT", "LOST", "UNKNOWN"] as const;
...
export function mapToCrmState(client: {
  ...
  if (client.status === "active" && client.archivalState === "GELADEIRA") return "DORMANT";
