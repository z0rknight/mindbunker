...
Companion to `RMEDIA_OS_INTERACTION_AND_MOTION_SYSTEM_2026_09.md` and the lab (`docs/design/rmedia-os-interaction-lab.*`). Line references are from source at `21cc20b`. **Status: M1 IMPLEMENTED (2026-09-20); M2–M6 are planning only.**
